========================================================================
    APLICACIÓN DE WIN32: forms Información general del 
    proyecto
========================================================================

AppWizard ha creado esta aplicación forms.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la forms aplicación.
...
small.ico
    ...
    de recursos principal forms.rc.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado forms.pch y un archivo de 
